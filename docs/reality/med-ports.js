/** Shared route-marker port seeds — keep in sync with GROVEEMODEL app/src/realityData/medPorts.ts */
window.RC_MED_PORTS = [
  {name:'Haifa Cargo',lat:32.82,lon:35.00,h:270,t:70,dst:'ILHFA'},{name:'Haifa Port Route',lat:32.79,lon:35.02,h:270,t:70,dst:'ILHFA'},{name:'Ashdod Container',lat:31.83,lon:34.63,h:250,t:70,dst:'ILASH'},
...
window.RC_WORLD_PORTS = [
  ...
  {name:'Vancouver',lat:49.28,lon:-123.12,h:315,t:70,dst:'CAVAN'},{name:'Dubai Jebel Ali',lat:25.01,lon:55.06,h:45,t:80,dst:'AEJEA'},
  {name:'Gibraltar',lat:36.14,lon:-5.35,h:90,t:70,dst:'GIB'},{name:'Malacca',lat:2.50,lon:101.80,h:45,t:80,dst:'MYMKZ'},
  {name:'North Atlantic',lat:45.0,lon:-40.0,h:270,t:70,dst:'ATL'},{name:'South Pacific',lat:-20.0,lon:-140.0,h:90,t:70,dst:'PAC'},
