 ...
 * Run in browser console: QADiag.runAll()  or  QADiag.test('aviation')
 */
const QADiag = (() => {
  const results = [];
...
console.log('%c[QA] Diagnostics loaded. Run QADiag.runAll() or QADiag.test("aviation")', 'color:#00e5ff;font-weight:bold');
window.QADiag = QADiag;
