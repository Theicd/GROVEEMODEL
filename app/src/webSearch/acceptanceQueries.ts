...
export const ACCEPTANCE_QUERIES: AcceptanceQuery[] = [
  ...
  { id: "QA-N01", category: "חדשות", query: "מה החדשות האחרונות על OpenAI?", expectIntents: ["news"], expectProvidersOk: ["grovee-news"], expectTextIncludes: [], notesHe: "GROVEE NEWS local engine" },
  { id: "QA-N02", category: "חדשות", query: "מה הכותרת הראשית באתר BBC עכשיו?", expectIntents: ["news"], expectProvidersOk: ["grovee-news"], expectTextIncludes: [], notesHe: "" },
  {
    id: "QA-N03",
    category: "חדשות",
    query: "מה הכותרות החדשות העיקריות בעולם",
    expectIntents: ["news"],
    expectProvidersOk: ["grovee-news"],
    expectTextIncludes: [],
    notesHe: "world headline — GROVEE NEWS Topics",
  },
  ...
  { id: "QA-WF2", category: "web-fallback", query: "מה קורה בעולם?", expectIntents: ["news"], expectProvidersOk: ["grovee-news", "searxng"], expectTextIncludes: [], notesHe: "Bare world → GROVEE NEWS + SearXNG blend" },
